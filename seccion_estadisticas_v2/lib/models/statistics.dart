...
class Statistics {
  ...
  Statistics({required this.totalBookings, required this.totalBilledAmount,required this.employeeId,required this.serviceId, required this.progress, required this.totalBookingsPerEmployee, required this.totalBookingsByStatus,required this.totalBookingsPerService,required this.totalBookingsPerPlatform});
